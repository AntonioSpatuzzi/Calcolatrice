...
public class CalcolatriceTest {
    ...
    @Test
    public void TestSottrazione() { assertTrue("sottrazione corretta",calcolatrice.sottrazione(5,3)==2);}

    @Test
    public void TestDivisione() {assertTrue("divisione corretta",calcolatrice.sottrazione(10,2)==5);}
